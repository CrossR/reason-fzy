...
let fzySearchArray = (haystack, needle, ~sorted=true, ()) => _searchInArray(haystack, needle, sorted);
let fzySearchList = (haystack, needle, ~sorted=true, ()) => _searchInList(haystack, needle, sorted);
